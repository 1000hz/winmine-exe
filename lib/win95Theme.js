export default {
  ...
  cursors: {
    webkitDefault: `-webkit-image-set(url(${require("~/static/cursor-default.png")}) 1x, url(${require("~/static/cursor-default.svg")}) 2x), default`,
    default: `url(${require("~/static/cursor-default.png")}), default`,
